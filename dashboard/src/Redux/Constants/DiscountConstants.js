...
export const DISCOUNT_SINGLE_REQUEST = "DISCOUNT_SINGLE_REQUEST";
export const DISCOUNT_SINGLE_SUCCESS = "DISCOUNT_SINGLE_SUCCESS";
export const DISCOUNT_SINGLE_FAIL = "DISCOUNT_SINGLE_FAIL";
export const DISCOUNT_SINGLE_RESET = "DISCOUNT_SINGLE_RESET";
